...
\begin{lstlisting}[language=Scala, caption={Random Seed}, label={lst:randseed},float,floatplacement=H]
    val seed = System.nanoTime + Thread .currentThread().getId + step + currentNode.toInt
\end{lstlisting}

% \begin{lstlisting}[
% language=Scala, caption={Random Seed}, label={lst:randseed},float=H
% ]
% val seed = System.nanoTime + Thread .currentThread().getId + step + currentNode.toInt
% \end{lstlisting}
